...
def function3():
    ...
    x = a[[3,6,10,13,17,20,24,27,31,34,38,41,45,48,52,55,59,62,66,69,73,76,80,83,87,90,94,97],[4,9,4,9,4,9,4,9,4,9,4,9,4,9,4,9,4,9,4,9,4,9,4,9,4,9,4,9]]#wrtie your code here
    return x
    """
    Expected Output:
...
def function5():
    ...
    z = np.empty(20).reshape(4,5)#wrtie your code here
...
def function6():
    ...
    arr = np.empty(10);arr.put([4,7], (10,20)) #wrtie your code here
...
def function9():
    ...
    a = np.arange(start=2, stop=101, step=2) # write your code here
...
def function11():
    ...
    ans = np.where(np.remainder(arr,2) != 0,-1,arr) #write your code here 
...
def function17():
    ...
    return np.where(np.remainder(arr,15) == 0,"Yes", "No")         # Write Your Code HERE
